...
<div class="row">
    <!-- <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <canvas id="chartjsExpensesBar"></canvas>
            </div>
        </div>
    </div> -->
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <canvas id="exps" height="200" class="chartjs chartjs-render-monitor"></canvas>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Transaction History</h4>
                <form action="<?= base_url('/transactions/exportexpenses') ?>" method="post">
