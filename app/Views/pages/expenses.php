            ...
            <div class="card-body">
                <div class="transaction-table">
                    <div class="table-responsive">
                        <table class="table mb-0 table-responsive-sm category-type table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>Category</th>
                                    <th>Type</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="right-category">
                                                    ...
                                                    <a href="#" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this transaction?')) { document.getElementById('deleteForm-<?= $transaction['id'] ?>').submit(); }">
                                                        <span><i class="fi fi-rr-trash"></i></span>
                                                    </a>

                                                    <form id="deleteForm-<?= $transaction['id'] ?>" action="<?= base_url('/transactions/delete/' . $transaction['id']) ?>" method="post" style="display:none;"></form>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
